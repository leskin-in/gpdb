...
test_xactdescprepareAbort(void **state)
{
	...
	assert_string_equal("prepare: at = 2019-07-30 18:26:11.83003+00; gid = 4242424242-0000000042; tablespace_oid_to_delete_on_abort = 42", buf->data);
}
...
test_xactdescprepareNone(void **state)
{
	...
	assert_string_equal("prepare: at = 2019-07-30 18:26:11.83003+00; gid = 4242424242-0000000042", buf->data);
}
